...
{
    ?>
A total number of <?php echo $this->Result ?> permissions where deleted <?php 
...
<form method="post">Select permissions you want to delete:
<div id="Permissions" >
<?php
...
<span style='font-size:smaller;'>Warning: You can not undo this operation! By clicking the delete button permissions would be instantly deleted.</span>
<script>
